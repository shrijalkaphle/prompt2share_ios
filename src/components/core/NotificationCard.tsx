...
export const NotificationCard = ({ message, is_read }: INotificationCardProps) => {
    ...
    return (
        <StyledTouchableOpacity className={`w-full p-4 shadow rounded-lg border-b border-white/10 flex flex-row gap-x-4 items-center ${is_read ? '' : 'bg-white/10'}`} onPress={markAsRead}>
