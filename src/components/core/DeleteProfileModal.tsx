...
export const DeleteProfileModal = ({ modelState, setModelState }: IDeleteProfileModal) => {
            ...
            <StyledView className="h-full flex items-center justify-center bg-black/60 p-4">
                ...
                <StyledView className="w-3/4 flex items-center bg-background rounded-3xl">
                    <StyledView className="p-4 py-6">
                        ...
                        <StyledText className="text-white text-center mt-6">Your account, post and all associated trophy and rewards will be deleted. This process cannot be reverted.</StyledText>
                    </StyledView>
