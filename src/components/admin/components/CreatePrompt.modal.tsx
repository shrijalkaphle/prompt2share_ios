...
import { createPrompt } from "../../../services/admin.service"
...
export const CreatePromptModal = ({modelState, setModelState, setPrompts, prompts} : any) => {
    const init = {
        "name": '',
    }
    ...
    const updateWithdrawRequest = async (value: CreatePrompt) => {
        ...
        const response = await createPrompt(value)
        ...
        <Modal visible={modelState} animationType="slide" onRequestClose={() => setModelState(false)} presentationStyle="formSheet">
            ...
            <StyledView className="w-full p-4 bg-background rounded-lg">
                    <StyledView className="flex flex-row items-center justify-between">
                        <StyledText className="text-white font-bold text-lg">Create Prompt</StyledText>
